...
def main():
    ...
    # Calculate Leggett criteria
    Q_0 = stand_utils.calc_legett(psi_data, x_vals, params['nodes'], t_index)
    print(f"The Leggett criteria Q0 = {Q_0}")

    # Plotting could be added here if needed, similar to your example
