...
# Plots the amplitude (Through space) of the psi data at a specific specified time 
...
ax.set_title(r"Evolution of $|\psi|^2$ at t = " + str(t))
ax.set_xlabel(r"$q_c x$", fontsize=14)
ax.set_ylabel(r"$|\psi|^2$", fontsize=14)
ax.plot(x_vals, psi_vals_at_t)
plt.show()
